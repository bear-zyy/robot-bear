...
-(void)application:(UIApplication *)application performActionForShortcutItem:(nonnull UIApplicationShortcutItem *)shortcutItem completionHandler:(nonnull void (^)(BOOL))completionHandler{
    ...
    if ([shortcutItem.localizedTitle isEqualToString:@"哈哈哈哈"]) {
    ...
    else if ([shortcutItem.localizedTitle isEqualToString:@"爱你一万年"]){
    
        SecendViewController * secend = [[SecendViewController alloc]init];
        
        self.window.rootViewController = secend;
        ...
        self.window.rootViewController = thire;
